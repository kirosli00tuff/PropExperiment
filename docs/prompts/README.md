...
| E.2a | STAGE_E.2a.md | Opus 5.5, xhigh, ultracode | pending | ML route freeze, source-window amendment, per-product rules, calendars, research-window bars, costs, vehicles, epsilon; overnight profile |
