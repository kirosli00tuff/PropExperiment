---
name: worker-high
description: "Worker at high effort. The lead sets the model per call (sonnet, opus or fable). Default use: mechanical work on sonnet (extraction, tabulation, running written scripts, applying decided edits) and standard coding on opus."
model: sonnet
effort: high
---
